...
namespace sdk::iface
{
    ...
    public:
        ...
        [[nodiscard]] uint16_t getFieldsSize() const {
            return *reinterpret_cast<const uint16_t*>(this + 0x10);
        }
     ...
     * void*(__thiscall*)(void* instance, C_SchemaClassInfo* out, const char* className);
     */
    ...
    public:
        ...
        C_SchemaClassInfo* findDeclaredClass(const char* className)
        {
            ...
            memory::vmt::call<C_SchemaClassInfo*>(this, FIND_DECLARED_CLASS_VMT_INDEX, &res, className);
